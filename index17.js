...
(async () => {
  const listingUrl = 'https://www.cartagenaservice.com/property/isla-de-lujo-para-18-pax-islas-del-rosario';
  ...
  if (!fs.existsSync('7BRExclusive5Bungalows')) fs.mkdirSync('7BRExclusive5Bungalows');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`7BRExclusive5Bungalows/${filename}`, buffer);
