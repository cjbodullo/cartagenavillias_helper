...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1293760957022549043?source_impression_id=p3_1769407868_P3GEd1GEZj5pe4tj&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '5 BR Modern 5-bedroom house - Cartagena City Center - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('5BRModernhouseCartagena')) fs.mkdirSync('5BRModernhouseCartagena');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`5BRModernhouseCartagena/${filename}`, buffer);
