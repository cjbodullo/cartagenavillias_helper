...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1506655072649527568?source_impression_id=p3_1769408282_P3JnrKjU2oGsAPv7&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '5 BR Luxury oasis in the heart of the city with 5 bedrooms, pool and jacuzzi - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('5BRoasis')) fs.mkdirSync('5BRoasis');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`5BRoasis/${filename}`, buffer);
