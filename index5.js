...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1550874490682248252?source_impression_id=p3_1769406922_P3QZOFmtRW5CuYlr&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '5 BR Luxury 5-bedroom mansion in the walled city - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('5BRLuxury5-bedroom')) fs.mkdirSync('5BRLuxury5-bedroom');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`5BRLuxury5-bedroom/${filename}`, buffer);
