...
(async () => {
  const listingUrl = 'https://www.cartagenaservice.com/property/casa-de-lujo-la-muralla-en-tierra-bomba';
   const outputDir = '6BDRMPrivateMansionwithTennisCourt';
  const baseName = '6 BDRM Private Mansion with Tennis Court - Private Island Rental - Cartagena Villas Colombia';
