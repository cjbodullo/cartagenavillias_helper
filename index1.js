...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1529074562084264949?source_impression_id=p3_1769406305_P3JURdptSJbbpLLf&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '5 BR Casa 1999 - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('5BRCasa1999')) fs.mkdirSync('5BRCasa1999');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`5BRCasa1999/${filename}`, buffer);
