...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1213966815958943834?source_impression_id=p3_1769406536_P3afh_Ao8HTAZg83&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '6 BR Luxury villa with swimming pools, butler and daily breakfast - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('6BRLuxuryvilla')) fs.mkdirSync('6BRLuxuryvilla');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`6BRLuxuryvilla/${filename}`, buffer);
