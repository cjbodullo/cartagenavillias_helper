...
(async () => {
  const listingUrl = 'https://www.cartagenaservice.com/property/villa-de-lujo-en-baru';
   const outputDir = '6BDRMPrivateBeachHouseBaru';
  const baseName = '6 BDRM Private Beach House Baru - Private Island Rental - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('6BDRMPrivateBeachHouseBaru')) fs.mkdirSync('6BDRMPrivateBeachHouseBaru');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`6BDRMPrivateBeachHouseBaru/${filename}`, buffer);
