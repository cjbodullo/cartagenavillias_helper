...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1552422907947830777?source_impression_id=p3_1770679720_P3Ze-vTSkWf7wahk&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '5 BDRM NEW Private Beach House with private Beach- Private Island Rental - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('5BDRMNEWPrivateBeach')) fs.mkdirSync('5BDRMNEWPrivateBeach');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`5BDRMNEWPrivateBeach/${filename}`, buffer);
