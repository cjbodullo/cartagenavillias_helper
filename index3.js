...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/736245579394454745?source_impression_id=p3_1769406755_P3wMaEKywYosnGMh&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '4 BR Casa Mariana - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('4BRCasaMariana')) fs.mkdirSync('4BRCasaMariana');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`4BRCasaMariana/${filename}`, buffer);
