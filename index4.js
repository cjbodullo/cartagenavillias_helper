...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1503721138226969743?source_impression_id=p3_1769409306_P3nlU8_bLMA7PiqO&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '6 BR Casa IsaLuna - Oasis Privado de Lujo - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('6BRCasaIsaLuna')) fs.mkdirSync('6BRCasaIsaLuna');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`6BRCasaIsaLuna/${filename}`, buffer);
