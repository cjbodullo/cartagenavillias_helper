...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/41722790?source_impression_id=p3_1769407274_P3jag18IO1vdanhS&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '7 BR Corner House of Seven Infants - authentic - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('7BRCornerHouse')) fs.mkdirSync('7BRCornerHouse');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`7BRCornerHouse/${filename}`, buffer);
