...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/1289781614229246342?source_impression_id=p3_1770607552_P3xrPPLK3asqWMuk&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '4 BR White Sand Beach House in Baru - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('4BRWhiteSandBeachHouseinBaru')) fs.mkdirSync('4BRWhiteSandBeachHouseinBaru');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`4BRWhiteSandBeachHouseinBaru/${filename}`, buffer);
