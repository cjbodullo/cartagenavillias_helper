...
(async () => {
  const listingUrl = 'https://www.airbnb.com/rooms/41769343?source_impression_id=p3_1770607397_P3arHx656ALdQ5Rs&modal=PHOTO_TOUR_SCROLLABLE';
  const baseName = '4 BR Beautiful Private Beach House - Cartagena Villas Colombia';
  ...
  if (!fs.existsSync('4BRBeautifulPrivateBeachHouse')) fs.mkdirSync('4BRBeautifulPrivateBeachHouse');
  ...
  for (const imgUrl of uniqueImages) {
    try {
      ...
      fs.writeFileSync(`4BRBeautifulPrivateBeachHouse/${filename}`, buffer);
